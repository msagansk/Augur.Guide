...
The migration of the non-forking markets can be done by anyone who wants to, but especially the [market creator]({{glossary_market_creator}}) and the traders who have [shares]({{glossary_share}}) in the market may want to do. Since for the market creator to receive the creator fees and for the traders to claim a payout of their shares, the market needs to be finalized (However creator fees are forfeit in [invalid]({glossary_invalid_Outcome}}) markets). It might give them an incentive to migrate markets.
...
## Finalized Markets
The finalized markets and its attached objects ([share]({{glossary_share}}), [unfilled order]({{glossary_unfilled_order}}), and [creator fee]({{glossary_creator_fee}})) can not be migrated. However, you can still trade and [settle]({{glossary_settlement}}) your [shares]({{glossary_share}}) on the markets during/after a [fork]({{glossary_fork}}).
